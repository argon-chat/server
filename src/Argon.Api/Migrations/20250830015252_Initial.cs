        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Archetypes_Servers_SpaceId",
                        column: x => x.SpaceId,
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_Servers_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Servers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ServerInvites_Servers_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Servers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Channels_Servers_SpaceId",
                        column: x => x.SpaceId,
                        principalTable: "Servers",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_ServerMemberArchetypes", x => new { x.SpaceMemberId, x.ArchetypeId });
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_ServerMemberArchetypes_UsersToServerRelations_SpaceMemberId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    SpaceCategoryEntityId = table.Column<Guid>(type: "uuid", nullable: true),
                    CreatedAt = table.Column<long>(type: "bigint", nullable: false),
                    UpdatedAt = table.Column<long>(type: "bigint", nullable: false),
                    DeletedAt = table.Column<long>(type: "bigint", nullable: true),
                    IsDeleted = table.Column<bool>(type: "boolean", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChannelEntitlementOverwrites_Categories_SpaceCategoryEntity~",
                        column: x => x.SpaceCategoryEntityId,
                        principalTable: "Categories",
                        principalColumn: "Id");
                    table.ForeignKey(
            ...
            migrationBuilder.InsertData(
                table: "Users",
                columns: new[] { "Id", "AvatarFileId", "CreatedAt", "DeletedAt", "DisplayName", "Email", "IsDeleted", "LockDownExpiration", "LockdownReason", "NormalizedUsername", "PasswordDigest", "PhoneNumber", "UpdatedAt", "Username" },
                values: new object[] { new Guid("11111111-2222-1111-2222-111111111111"), null, -62135596800000L, null, "System", "system@argon.gl", false, null, 0, "system", null, null, -62135596800000L, "system" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { new Guid("11111111-3333-0000-1111-111111111111"), -8355712, 1732377674205L, new Guid("11111111-2222-1111-2222-111111111111"), null, "Default role for everyone in this server", 15761383m, null, false, false, false, false, false, true, "everyone", new Guid("11111111-0000-1111-1111-111111111111"), -62135596800000L },
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChannelEntitlementOverwrites_SpaceCategoryEntityId",
                table: "ChannelEntitlementOverwrites",
                column: "SpaceCategoryEntityId");
