...
//    public async Task<Either<SpaceEntity, AcceptInviteError>> JoinToServerAsync(InviteCode inviteCode)
//    {
...
//        return await this.GetGrainFactory().GetGrain<ISpaceGrain>(result.Item1).GetServer();
//    }
