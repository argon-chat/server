...
public sealed class Ion_SearchUserResult_Formatter : IonFormatter<SearchUserResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "SearchUserResult");
...
public sealed class Ion_UserCardDetails_Formatter : IonFormatter<UserCardDetails>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(18, "UserCardDetails");
...
public sealed class Ion_UserAccountInfo_Formatter : IonFormatter<UserAccountInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(18, "UserAccountInfo");
...
public sealed class Ion_InventoryItemInfo_Formatter : IonFormatter<InventoryItemInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "InventoryItemInfo");
...
public sealed class Ion_BoxContentInfo_Formatter : IonFormatter<BoxContentInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "BoxContentInfo");
        var __itemid = IonFormatterStorage<guid>.Read(reader);
        var __templateid = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_MessageInfo_Formatter : IonFormatter<MessageInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "MessageInfo");
...
public sealed class Ion_DeviceHistoryInfo_Formatter : IonFormatter<DeviceHistoryInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "DeviceHistoryInfo");
...
public sealed class Ion_RedeemedCouponInfo_Formatter : IonFormatter<RedeemedCouponInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "RedeemedCouponInfo");
...
public sealed class Ion_UserSpaceInfo_Formatter : IonFormatter<UserSpaceInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "UserSpaceInfo");
        var __spaceid = IonFormatterStorage<guid>.Read(reader);
...
public sealed class Ion_UserLevelInfo_Formatter : IonFormatter<UserLevelInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "UserLevelInfo");
...
public sealed class Ion_UserStatsInfo_Formatter : IonFormatter<UserStatsInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "UserStatsInfo");
...
public sealed class Ion_UserTeamInfo_Formatter : IonFormatter<UserTeamInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "UserTeamInfo");
...
public sealed class Ion_AutoDeleteSettingsInfo_Formatter : IonFormatter<AutoDeleteSettingsInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "AutoDeleteSettingsInfo");
...
public sealed class Ion_PlatformStats_Formatter : IonFormatter<PlatformStats>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(14, "PlatformStats");
...
public sealed class Ion_ItemTemplateList_Formatter : IonFormatter<ItemTemplateList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "ItemTemplateList");
...
public sealed class Ion_ItemTemplateInfo_Formatter : IonFormatter<ItemTemplateInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "ItemTemplateInfo");
        var __itemid = IonFormatterStorage<guid>.Read(reader);
        var __templateid = IonFormatterStorage<string>.Read(reader);
        var __isusable = IonFormatterStorage<bool>.Read(reader);
        var __isgiftable = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_CreateItemTemplateResult_Formatter : IonFormatter<CreateItemTemplateResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "CreateItemTemplateResult");
...
public sealed class Ion_DeleteItemResult_Formatter : IonFormatter<DeleteItemResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "DeleteItemResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
        var __itemid = reader.ReadNullable<guid>();
        var __error = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 3);
...
public sealed class Ion_CouponList_Formatter : IonFormatter<CouponList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "CouponList");
...
public sealed class Ion_CouponInfo_Formatter : IonFormatter<CouponInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "CouponInfo");
        var __couponid = IonFormatterStorage<guid>.Read(reader);
...
public sealed class Ion_CreateCouponInput_Formatter : IonFormatter<CreateCouponInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "CreateCouponInput");
        var __code = IonFormatterStorage<string>.Read(reader);
        var __description = reader.ReadNullable<string>();
        var __validfrom = IonFormatterStorage<datetime>.Read(reader);
        var __validto = IonFormatterStorage<datetime>.Read(reader);
...
public sealed class Ion_CreateCouponResult_Formatter : IonFormatter<CreateCouponResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "CreateCouponResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_UserActionResult_Formatter : IonFormatter<UserActionResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "UserActionResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
        var __error = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 2);
...
public sealed class Ion_DiagnosticsResult_Formatter : IonFormatter<DiagnosticsResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "DiagnosticsResult");
...
public sealed class Ion_RuntimeDiagnostics_Formatter : IonFormatter<RuntimeDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(11, "RuntimeDiagnostics");
...
public sealed class Ion_DatabaseDiagnostics_Formatter : IonFormatter<DatabaseDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "DatabaseDiagnostics");
...
public sealed class Ion_KubernetesDiagnostics_Formatter : IonFormatter<KubernetesDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "KubernetesDiagnostics");
...
public sealed class Ion_NatsDiagnostics_Formatter : IonFormatter<NatsDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "NatsDiagnostics");
...
public sealed class Ion_RedisDiagnostics_Formatter : IonFormatter<RedisDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "RedisDiagnostics");
        var __isconnected = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_OrleansDiagnostics_Formatter : IonFormatter<OrleansDiagnostics>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "OrleansDiagnostics");
...
public sealed class Ion_OperatorList_Formatter : IonFormatter<OperatorList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "OperatorList");
...
public sealed class Ion_OperatorInfo_Formatter : IonFormatter<OperatorInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "OperatorInfo");
...
public sealed class Ion_OperatorCertificateInfo_Formatter : IonFormatter<OperatorCertificateInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(11, "OperatorCertificateInfo");
...
public sealed class Ion_OperatorDetails_Formatter : IonFormatter<OperatorDetails>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "OperatorDetails");
...
public sealed class Ion_CreateOperatorInput_Formatter : IonFormatter<CreateOperatorInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "CreateOperatorInput");
        var __displayname = IonFormatterStorage<string>.Read(reader);
        var __email = IonFormatterStorage<string>.Read(reader);
        var __userid = reader.ReadNullable<guid>();
        var __issystemoperator = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_CreateOperatorResult_Formatter : IonFormatter<CreateOperatorResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "CreateOperatorResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_OperatorActionResult_Formatter : IonFormatter<OperatorActionResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "OperatorActionResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
        var __error = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 2);
        return new(__success, __error);
...
public sealed class Ion_EnrollCertificateResult_Formatter : IonFormatter<EnrollCertificateResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "EnrollCertificateResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_OperatorAppAccessList_Formatter : IonFormatter<OperatorAppAccessList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "OperatorAppAccessList");
...
public sealed class Ion_OperatorAppAccessEntry_Formatter : IonFormatter<OperatorAppAccessEntry>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "OperatorAppAccessEntry");
        var __operatorid = IonFormatterStorage<guid>.Read(reader);
...
public sealed class Ion_GrantOperatorAppAccessInput_Formatter : IonFormatter<GrantOperatorAppAccessInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "GrantOperatorAppAccessInput");
        var __operatorid = IonFormatterStorage<guid>.Read(reader);
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __allowedscopes = IonFormatterStorage<string>.ReadArray(reader);
        var __claims = IonFormatterStorage<string>.ReadArray(reader);
...
public sealed class Ion_UpdateOperatorAppAccessInput_Formatter : IonFormatter<UpdateOperatorAppAccessInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "UpdateOperatorAppAccessInput");
        var __operatorid = IonFormatterStorage<guid>.Read(reader);
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __allowedscopes = IonFormatterStorage<string>.ReadArray(reader);
        var __claims = IonFormatterStorage<string>.ReadArray(reader);
...
public sealed class Ion_OperatorAppAccessResult_Formatter : IonFormatter<OperatorAppAccessResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "OperatorAppAccessResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
        var __error = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 2);
        return new(__success, __error);
...
public sealed class Ion_InternalAppSearchResult_Formatter : IonFormatter<InternalAppSearchResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "InternalAppSearchResult");
...
public sealed class Ion_InternalAppInfo_Formatter : IonFormatter<InternalAppInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "InternalAppInfo");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_AuditLogQuery_Formatter : IonFormatter<AuditLogQuery>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AuditLogQuery");
        var __operatorid = reader.ReadNullable<guid>();
...
public sealed class Ion_AuditLogPage_Formatter : IonFormatter<AuditLogPage>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AuditLogPage");
...
public sealed class Ion_AuditEntry_Formatter : IonFormatter<AuditEntry>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "AuditEntry");
...
public sealed class Ion_AdminBotSearchResult_Formatter : IonFormatter<AdminBotSearchResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "AdminBotSearchResult");
        var __found = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_AdminBotSummary_Formatter : IonFormatter<AdminBotSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "AdminBotSummary");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __description = reader.ReadNullable<string>();
...
public sealed class Ion_AdminBotCard_Formatter : IonFormatter<AdminBotCard>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(18, "AdminBotCard");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __description = reader.ReadNullable<string>();
...
public sealed class Ion_AdminBotSpaceInfo_Formatter : IonFormatter<AdminBotSpaceInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "AdminBotSpaceInfo");
        var __spaceid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
        var __membercount = IonFormatterStorage<i4>.Read(reader);
...
public sealed class Ion_AdminBotCommandInfo_Formatter : IonFormatter<AdminBotCommandInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "AdminBotCommandInfo");
...
public sealed class Ion_AdminUserSummary_Formatter : IonFormatter<AdminUserSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AdminUserSummary");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __displayname = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminTeamSearchResult_Formatter : IonFormatter<AdminTeamSearchResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "AdminTeamSearchResult");
        var __found = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_AdminTeamSummary_Formatter : IonFormatter<AdminTeamSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminTeamSummary");
        var __teamid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminTeamCard_Formatter : IonFormatter<AdminTeamCard>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminTeamCard");
        var __teamid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminTeamMemberInfo_Formatter : IonFormatter<AdminTeamMemberInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminTeamMemberInfo");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __displayname = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminTeamAppInfo_Formatter : IonFormatter<AdminTeamAppInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "AdminTeamAppInfo");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __apptype = IonFormatterStorage<AdminDevAppType>.Read(reader);
        var __isinternalapp = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_AdminSpaceSearchResult_Formatter : IonFormatter<AdminSpaceSearchResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "AdminSpaceSearchResult");
        var __found = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_AdminSpaceSummary_Formatter : IonFormatter<AdminSpaceSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "AdminSpaceSummary");
        var __spaceid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
        var __membercount = IonFormatterStorage<i4>.Read(reader);
...
public sealed class Ion_AdminChannelInfo_Formatter : IonFormatter<AdminChannelInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "AdminChannelInfo");
        var __channelid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_AdminChannelGroupInfo_Formatter : IonFormatter<AdminChannelGroupInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AdminChannelGroupInfo");
...
public sealed class Ion_AdminArchetypeInfo_Formatter : IonFormatter<AdminArchetypeInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminArchetypeInfo");
...
public sealed class Ion_AdminSpaceBotInfo_Formatter : IonFormatter<AdminSpaceBotInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminSpaceBotInfo");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminInviteInfo_Formatter : IonFormatter<AdminInviteInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "AdminInviteInfo");
        var __code = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_AdminSpaceMemberPage_Formatter : IonFormatter<AdminSpaceMemberPage>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AdminSpaceMemberPage");
...
public sealed class Ion_AdminSpaceMemberInfo_Formatter : IonFormatter<AdminSpaceMemberInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "AdminSpaceMemberInfo");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __displayname = IonFormatterStorage<string>.Read(reader);
        var __avatarfileid = reader.ReadNullable<string>();
...
public sealed class Ion_AdminUserBotInfo_Formatter : IonFormatter<AdminUserBotInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "AdminUserBotInfo");
        var __appid = IonFormatterStorage<guid>.Read(reader);
        var __name = IonFormatterStorage<string>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __isverified = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_AdminPremiumInfo_Formatter : IonFormatter<AdminPremiumInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(11, "AdminPremiumInfo");
...
public sealed class Ion_AdminTransactionPage_Formatter : IonFormatter<AdminTransactionPage>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AdminTransactionPage");
...
public sealed class Ion_AdminTransactionInfo_Formatter : IonFormatter<AdminTransactionInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(15, "AdminTransactionInfo");
...
public sealed class Ion_AdminTransactionDetails_Formatter : IonFormatter<AdminTransactionDetails>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "AdminTransactionDetails");
...
public sealed class Ion_AdminTransactionItemInfo_Formatter : IonFormatter<AdminTransactionItemInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "AdminTransactionItemInfo");
        var __itemid = IonFormatterStorage<guid>.Read(reader);
        var __templateid = IonFormatterStorage<string>.Read(reader);
        var __createdat = IonFormatterStorage<datetime>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 3);
...
public sealed class Ion_AdminReportPage_Formatter : IonFormatter<AdminReportPage>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "AdminReportPage");
...
public sealed class Ion_ResolveReportInput_Formatter : IonFormatter<ResolveReportInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "ResolveReportInput");
        var __reportid = IonFormatterStorage<guid>.Read(reader);
        var __status = IonFormatterStorage<ReportStatus>.Read(reader);
        var __resolutionnote = reader.ReadNullable<string>();
...
public sealed class Ion_AdminUserTrustCard_Formatter : IonFormatter<AdminUserTrustCard>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(10, "AdminUserTrustCard");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_FeatureFlagList_Formatter : IonFormatter<FeatureFlagList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "FeatureFlagList");
...
public sealed class Ion_FeatureFlagSummary_Formatter : IonFormatter<FeatureFlagSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "FeatureFlagSummary");
...
public sealed class Ion_FeatureFlagDetails_Formatter : IonFormatter<FeatureFlagDetails>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(9, "FeatureFlagDetails");
        var __id = IonFormatterStorage<string>.Read(reader);
        var __description = reader.ReadNullable<string>();
        var __defaultenabled = IonFormatterStorage<bool>.Read(reader);
        var __rolloutpercentage = reader.ReadNullable<i4>();
...
public sealed class Ion_FeatureFlagOverrideInfo_Formatter : IonFormatter<FeatureFlagOverrideInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "FeatureFlagOverrideInfo");
...
public sealed class Ion_CreateFeatureFlagInput_Formatter : IonFormatter<CreateFeatureFlagInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "CreateFeatureFlagInput");
...
public sealed class Ion_UpdateFeatureFlagInput_Formatter : IonFormatter<UpdateFeatureFlagInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "UpdateFeatureFlagInput");
        var __flagid = IonFormatterStorage<string>.Read(reader);
        var __description = reader.ReadNullable<string>();
        var __defaultenabled = IonFormatterStorage<bool>.Read(reader);
        var __rolloutpercentage = reader.ReadNullable<i4>();
...
public sealed class Ion_SetFeatureFlagOverrideInput_Formatter : IonFormatter<SetFeatureFlagOverrideInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "SetFeatureFlagOverrideInput");
        var __flagid = IonFormatterStorage<string>.Read(reader);
        var __scope = IonFormatterStorage<i4>.Read(reader);
        var __targetid = IonFormatterStorage<string>.Read(reader);
        var __enabled = reader.ReadNullable<bool>();
...
public sealed class Ion_FeatureFlagActionResult_Formatter : IonFormatter<FeatureFlagActionResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "FeatureFlagActionResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_TenantDirectoryList_Formatter : IonFormatter<TenantDirectoryList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "TenantDirectoryList");
...
public sealed class Ion_TenantInfo_Formatter : IonFormatter<TenantInfo>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "TenantInfo");
...
public sealed class Ion_CreateTenantInput_Formatter : IonFormatter<CreateTenantInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "CreateTenantInput");
        var __domain = IonFormatterStorage<string>.Read(reader);
        var __instanceurl = IonFormatterStorage<string>.Read(reader);
        var __orgname = reader.ReadNullable<string>();
        var __owneruserid = reader.ReadNullable<guid>();
...
public sealed class Ion_UpdateTenantInput_Formatter : IonFormatter<UpdateTenantInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "UpdateTenantInput");
        var __tenantid = IonFormatterStorage<guid>.Read(reader);
        var __instanceurl = IonFormatterStorage<string>.Read(reader);
        var __orgname = reader.ReadNullable<string>();
        var __notes = reader.ReadNullable<string>();
...
public sealed class Ion_TenantActionResult_Formatter : IonFormatter<TenantActionResult>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "TenantActionResult");
        var __success = IonFormatterStorage<bool>.Read(reader);
...
public sealed class Ion_DeviceSummary_Formatter : IonFormatter<DeviceSummary>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(8, "DeviceSummary");
...
public sealed class Ion_DeviceList_Formatter : IonFormatter<DeviceList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "DeviceList");
...
public sealed class Ion_DeviceAccount_Formatter : IonFormatter<DeviceAccount>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(7, "DeviceAccount");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __displayname = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_DeviceAccountList_Formatter : IonFormatter<DeviceAccountList>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(1, "DeviceAccountList");
...
[GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
public sealed class Ion_EmailJournalPage_Formatter : IonFormatter<EmailJournalPage>
{
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public EmailJournalPage Read(CborReader reader)
    {
        var arraySize = reader.ReadStartMessage(4, "EmailJournalPage");
        var __entries = IonFormatterStorage<EmailJournalEntry>.ReadArray(reader);
        var __totalcount = IonFormatterStorage<i8>.Read(reader);
        var __offset = IonFormatterStorage<i4>.Read(reader);
        var __limit = IonFormatterStorage<i4>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 4);
        return new(__entries, __totalcount, __offset, __limit);
    ...
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public void Write(CborWriter writer, EmailJournalPage value)
    {
        writer.WriteStartArray(4);
        IonFormatterStorage<EmailJournalEntry>.WriteArray(writer, value.entries);
        IonFormatterStorage<i8>.Write(writer, value.totalCount);
        IonFormatterStorage<i4>.Write(writer, value.offset);
        IonFormatterStorage<i4>.Write(writer, value.limit);
        writer.WriteEndArray();
    }
...
[GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
public sealed class Ion_EmailJournalEntry_Formatter : IonFormatter<EmailJournalEntry>
{
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public EmailJournalEntry Read(CborReader reader)
    {
        var arraySize = reader.ReadStartMessage(5, "EmailJournalEntry");
        var __userid = reader.ReadNullable<guid>();
        var __kind = IonFormatterStorage<string>.Read(reader);
        var __sentat = IonFormatterStorage<datetime>.Read(reader);
        var __delivered = IonFormatterStorage<bool>.Read(reader);
        var __error = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 5);
        return new(__userid, __kind, __sentat, __delivered, __error);
    }
    
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public void Write(CborWriter writer, EmailJournalEntry value)
    {
        writer.WriteStartArray(5);
        IonFormatterStorage<guid>.WriteNullable(writer, value.userId);
        IonFormatterStorage<string>.Write(writer, value.kind);
        IonFormatterStorage<datetime>.Write(writer, value.sentAt);
        IonFormatterStorage<bool>.Write(writer, value.delivered);
        IonFormatterStorage<string>.WriteNullable(writer, value.error);
        writer.WriteEndArray();
    }
}
...
[GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
public sealed class Ion_InFlightDeletionPage_Formatter : IonFormatter<InFlightDeletionPage>
{
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public InFlightDeletionPage Read(CborReader reader)
    {
        var arraySize = reader.ReadStartMessage(5, "InFlightDeletionPage");
        var __entries = IonFormatterStorage<InFlightDeletionEntry>.ReadArray(reader);
        var __totalcount = IonFormatterStorage<i4>.Read(reader);
        var __failedcount = IonFormatterStorage<i4>.Read(reader);
        var __offset = IonFormatterStorage<i4>.Read(reader);
        var __limit = IonFormatterStorage<i4>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 5);
        return new(__entries, __totalcount, __failedcount, __offset, __limit);
    }
    
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public void Write(CborWriter writer, InFlightDeletionPage value)
    {
        writer.WriteStartArray(5);
        IonFormatterStorage<InFlightDeletionEntry>.WriteArray(writer, value.entries);
        IonFormatterStorage<i4>.Write(writer, value.totalCount);
        IonFormatterStorage<i4>.Write(writer, value.failedCount);
        IonFormatterStorage<i4>.Write(writer, value.offset);
        IonFormatterStorage<i4>.Write(writer, value.limit);
        writer.WriteEndArray();
    }
...
[GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
public sealed class Ion_InFlightDeletionEntry_Formatter : IonFormatter<InFlightDeletionEntry>
{
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public InFlightDeletionEntry Read(CborReader reader)
    {
        var arraySize = reader.ReadStartMessage(10, "InFlightDeletionEntry");
        var __userid = IonFormatterStorage<guid>.Read(reader);
        var __username = IonFormatterStorage<string>.Read(reader);
        var __displayname = IonFormatterStorage<string>.Read(reader);
        var __email = IonFormatterStorage<string>.Read(reader);
        var __status = IonFormatterStorage<AccountDeletionStatusView>.Read(reader);
        var __armedat = IonFormatterStorage<datetime>.Read(reader);
        var __executionat = reader.ReadNullable<datetime>();
        var __selfrequested = IonFormatterStorage<bool>.Read(reader);
        var __failurereason = reader.ReadNullable<string>();
        var __executionattempts = IonFormatterStorage<i4>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 10);
        return new(__userid, __username, __displayname, __email, __status, __armedat, __executionat, __selfrequested, __failurereason, __executionattempts);
    }
    
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public void Write(CborWriter writer, InFlightDeletionEntry value)
    {
        writer.WriteStartArray(10);
        IonFormatterStorage<guid>.Write(writer, value.userId);
        IonFormatterStorage<string>.Write(writer, value.username);
        IonFormatterStorage<string>.Write(writer, value.displayName);
        IonFormatterStorage<string>.Write(writer, value.email);
        IonFormatterStorage<AccountDeletionStatusView>.Write(writer, value.status);
        IonFormatterStorage<datetime>.Write(writer, value.armedAt);
        IonFormatterStorage<datetime>.WriteNullable(writer, value.executionAt);
        IonFormatterStorage<bool>.Write(writer, value.selfRequested);
        IonFormatterStorage<string>.WriteNullable(writer, value.failureReason);
        IonFormatterStorage<i4>.Write(writer, value.executionAttempts);
        writer.WriteEndArray();
    }
...
public sealed class Ion_AutoDeleteScanStatus_Formatter : IonFormatter<AutoDeleteScanStatus>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(16, "AutoDeleteScanStatus");
        var __enabled = IonFormatterStorage<bool>.Read(reader);
        ...
        var __defaultthresholdmonths = IonFormatterStorage<i4>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 16);
        return new(__enabled, __armedat, __nextdueat, __laststartedat, __lastfinishedat, __lasttrigger, __runs, __lastprocessed, __lastproposed, __lastenqueued, __lastretired, __lastheld, __lastqueuelength, __lasterror, __lasterrorat, __defaultthresholdmonths);
    }
    ...
    public void Write(CborWriter writer, AutoDeleteScanStatus value)
    {
        ...
        IonFormatterStorage<i4>.Write(writer, value.defaultThresholdMonths);
        writer.WriteEndArray();
    }
}
