...
public sealed class Ion_AdminConsole_ClientImpl(IonClientContext context) : IAdminConsole
{
    ...
    private static readonly Lazy<MethodInfo> GetAutoDeleteScanStatus_Ref = new(() =>
    ...
    private static readonly Lazy<MethodInfo> ExpireAccountDeletionGrace_Ref = new(() =>
        typeof(IAdminConsole).GetMethod(nameof(ExpireAccountDeletionGrace), BindingFlags.Public | BindingFlags.Instance)!);
    private static readonly Lazy<MethodInfo> EraseAccountNow_Ref = new(() =>
        typeof(IAdminConsole).GetMethod(nameof(EraseAccountNow), BindingFlags.Public | BindingFlags.Instance)!);
    ...
    {
        var req = new IonRequest(context, typeof(IAdminConsole), GetAutoDeleteScanStatus_Ref.Value);
    ...
    {
        var req = new IonRequest(context, typeof(IAdminConsole), RunAutoDeleteScan_Ref.Value);
    ...
    {
        var req = new IonRequest(context, typeof(IAdminConsole), StartAccountDeletion_Ref.Value);
    ...
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public async Task<UserActionResult> ExpireAccountDeletionGrace(guid __userid, CancellationToken ct = default)
    {
        var req = new IonRequest(context, typeof(IAdminConsole), ExpireAccountDeletionGrace_Ref.Value);
    ...
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public async Task<UserActionResult> EraseAccountNow(guid __userid, CancellationToken ct = default)
    {
        var req = new IonRequest(context, typeof(IAdminConsole), EraseAccountNow_Ref.Value);
