...
public sealed class Ion_TodayStats_Formatter : IonFormatter<TodayStats>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "TodayStats");
...
public sealed class Ion_MyLevelDetails_Formatter : IonFormatter<MyLevelDetails>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(5, "MyLevelDetails");
...
public sealed class Ion_FormField_Formatter : IonFormatter<FormField>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "FormField");
...
public sealed class Ion_UserEditInput_Formatter : IonFormatter<UserEditInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(11, "UserEditInput");
...
public sealed class Ion_FeatureFlag_Formatter : IonFormatter<FeatureFlag>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(4, "FeatureFlag");
        var __key = IonFormatterStorage<string>.Read(reader);
...
public sealed class Ion_FeatureFlagParameter_Formatter : IonFormatter<FeatureFlagParameter>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "FeatureFlagParameter");
        var __key = IonFormatterStorage<string>.Read(reader);
        var __value = IonFormatterStorage<string>.Read(reader);
        reader.ReadEndArrayAndSkip(arraySize - 2);
        return new(__key, __value);
...
public sealed class Ion_CreateServerRequest_Formatter : IonFormatter<CreateServerRequest>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "CreateServerRequest");
...
public sealed class Ion_UserCredentialsInput_Formatter : IonFormatter<UserCredentialsInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(6, "UserCredentialsInput");
...
public sealed class Ion_UserLoginInput_Formatter : IonFormatter<UserLoginInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(3, "UserLoginInput");
        var __email = reader.ReadNullable<string>();
        var __phone = reader.ReadNullable<string>();
        var __username = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 3);
...
public sealed class Ion_NewUserCredentialsInput_Formatter : IonFormatter<NewUserCredentialsInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(10, "NewUserCredentialsInput");
...
public sealed class Ion_LegalState_Formatter : IonFormatter<LegalState>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "LegalState");
        var __tosversion = reader.ReadNullable<string>();
        var __privacyversion = reader.ReadNullable<string>();
        reader.ReadEndArrayAndSkip(arraySize - 2);
...
public sealed class Ion_AcceptLegalInput_Formatter : IonFormatter<AcceptLegalInput>
{
    ...
    {
        var arraySize = reader.ReadStartMessage(2, "AcceptLegalInput");
...
[GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
public sealed class Ion_LookupError_Formatter : IonFormatter<LookupError>
{
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public LookupError Read(CborReader reader)
    {
         return (LookupError)(IonFormatterStorage<u2>.Read(reader));
    }
    
    [GeneratedCodeAttribute("ionc", null), CompilerGeneratedAttribute]
    public void Write(CborWriter writer, LookupError value)
    {
        var casted = (u2)value;
