...
internal static class IonProjectFormatterStorageModuleInit
{
    ...
    internal static void Init()
    {
      ...
      IonFormatterStorage<WornCosmetics>.Value = new Ion_WornCosmetics_Formatter();
      IonFormatterStorage<CosmeticCatalogue>.Value = new Ion_CosmeticCatalogue_Formatter();
      IonFormatterStorage<CosmeticKindSummary>.Value = new Ion_CosmeticKindSummary_Formatter();
      IonFormatterStorage<CatalogueCosmetic>.Value = new Ion_CatalogueCosmetic_Formatter();
      IonFormatterStorage<CosmeticText>.Value = new Ion_CosmeticText_Formatter();
      IonFormatterStorage<CatalogueBoardPolicy>.Value = new Ion_CatalogueBoardPolicy_Formatter();
      IonFormatterStorage<MyCosmetics>.Value = new Ion_MyCosmetics_Formatter();
      IonFormatterStorage<OwnedCosmetic>.Value = new Ion_OwnedCosmetic_Formatter();
      IonFormatterStorage<CosmeticLoadoutList>.Value = new Ion_CosmeticLoadoutList_Formatter();
      IonFormatterStorage<CosmeticLoadout>.Value = new Ion_CosmeticLoadout_Formatter();
      IonFormatterStorage<LoadoutIdentityInput>.Value = new Ion_LoadoutIdentityInput_Formatter();
      IonFormatterStorage<WidgetCard>.Value = new Ion_WidgetCard_Formatter();
      IonFormatterStorage<CosmeticScopeAssignment>.Value = new Ion_CosmeticScopeAssignment_Formatter();
      IonFormatterStorage<CosmeticAcquisition>.Value = new Ion_CosmeticAcquisition_Formatter();
      IonFormatterStorage<CosmeticError>.Value = new Ion_CosmeticError_Formatter();
      IonFormatterStorage<IWidgetPictureResult>.Value = new Ion_IWidgetPictureResult_Formatter();
      IonFormatterStorage<ICreateLoadoutResult>.Value = new Ion_ICreateLoadoutResult_Formatter();
      IonFormatterStorage<ILoadoutActionResult>.Value = new Ion_ILoadoutActionResult_Formatter();
      IonFormatterStorage<IEquipResult>.Value = new Ion_IEquipResult_Formatter();
      ...
      IonFormatterStorage<LoginRequestTicket>.Value = new Ion_LoginRequestTicket_Formatter();
      IonFormatterStorage<LoginRequestPreview>.Value = new Ion_LoginRequestPreview_Formatter();
      IonFormatterStorage<LoginRequestError>.Value = new Ion_LoginRequestError_Formatter();
      IonFormatterStorage<BadAuthKind>.Value = new Ion_BadAuthKind_Formatter();
      IonFormatterStorage<ICreateLoginRequestResult>.Value = new Ion_ICreateLoginRequestResult_Formatter();
      IonFormatterStorage<ILoginPollResult>.Value = new Ion_ILoginPollResult_Formatter();
      IonFormatterStorage<ILoginRequestPreviewResult>.Value = new Ion_ILoginRequestPreviewResult_Formatter();
      IonFormatterStorage<IApproveLoginRequestResult>.Value = new Ion_IApproveLoginRequestResult_Formatter();
      IonFormatterStorage<IRejectLoginRequestResult>.Value = new Ion_IRejectLoginRequestResult_Formatter();
      ...
      IonFormatterStorage<SessionInfo>.Value = new Ion_SessionInfo_Formatter();
      ...
      IonFormatterStorage<EquippedCosmetic>.Value = new Ion_EquippedCosmetic_Formatter();
      IonFormatterStorage<EquippedCosmeticOption>.Value = new Ion_EquippedCosmeticOption_Formatter();
      IonFormatterStorage<EquippedCosmeticAsset>.Value = new Ion_EquippedCosmeticAsset_Formatter();
      ...
      IonFormatterStorage<ClientPlatform>.Value = new Ion_ClientPlatform_Formatter();
      ...
      IonFormatterStorage<SuccessWidgetPicture>.Value = new Ion_SuccessWidgetPicture_Formatter();
      IonFormatterStorage<FailedWidgetPicture>.Value = new Ion_FailedWidgetPicture_Formatter();
      IonFormatterStorage<SuccessCreateLoadout>.Value = new Ion_SuccessCreateLoadout_Formatter();
      IonFormatterStorage<FailedCreateLoadout>.Value = new Ion_FailedCreateLoadout_Formatter();
      IonFormatterStorage<SuccessLoadoutAction>.Value = new Ion_SuccessLoadoutAction_Formatter();
      IonFormatterStorage<FailedLoadoutAction>.Value = new Ion_FailedLoadoutAction_Formatter();
      IonFormatterStorage<SuccessEquip>.Value = new Ion_SuccessEquip_Formatter();
      IonFormatterStorage<FailedEquip>.Value = new Ion_FailedEquip_Formatter();
      ...
      IonFormatterStorage<SuccessCreateLoginRequest>.Value = new Ion_SuccessCreateLoginRequest_Formatter();
      IonFormatterStorage<FailedCreateLoginRequest>.Value = new Ion_FailedCreateLoginRequest_Formatter();
      IonFormatterStorage<PendingLoginRequest>.Value = new Ion_PendingLoginRequest_Formatter();
      IonFormatterStorage<ApprovedLoginRequest>.Value = new Ion_ApprovedLoginRequest_Formatter();
      IonFormatterStorage<RejectedLoginRequest>.Value = new Ion_RejectedLoginRequest_Formatter();
      IonFormatterStorage<FailedLoginPoll>.Value = new Ion_FailedLoginPoll_Formatter();
      IonFormatterStorage<SuccessLoginRequestPreview>.Value = new Ion_SuccessLoginRequestPreview_Formatter();
      IonFormatterStorage<FailedLoginRequestPreview>.Value = new Ion_FailedLoginRequestPreview_Formatter();
      IonFormatterStorage<SuccessApproveLoginRequest>.Value = new Ion_SuccessApproveLoginRequest_Formatter();
      IonFormatterStorage<FailedApproveLoginRequest>.Value = new Ion_FailedApproveLoginRequest_Formatter();
      IonFormatterStorage<SuccessRejectLoginRequest>.Value = new Ion_SuccessRejectLoginRequest_Formatter();
      IonFormatterStorage<FailedRejectLoginRequest>.Value = new Ion_FailedRejectLoginRequest_Formatter();
      ...
      IonFormatterStorage<FailedRevokeSession>.Value = new Ion_FailedRevokeSession_Formatter();
      ...
      IonExecutorMetadataStorage.AddExecutor<Ion_CosmeticsInteraction_ServiceExecutor>("ICosmeticsInteraction");
      ...
      IonExecutorMetadataStorage.AddClient<Ion_CosmeticsInteraction_ClientImpl>("ICosmeticsInteraction");
