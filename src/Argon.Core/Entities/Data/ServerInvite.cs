...
public record ServerInvite : ArgonEntityWithOwnership<ulong>, IEntityTypeConfiguration<ServerInvite>, IMapper<ServerInvite, InviteCodeEntity>
{
    ...
    public static InviteCodeEntity Map(scoped in ServerInvite self)
...
public record struct InviteCodeEntityData(InviteCode code, Guid serverId, Guid issuerId, DateTimeOffset expireTime, long used)
{
