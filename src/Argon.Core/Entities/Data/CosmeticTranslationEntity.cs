...
///
/// <para><see cref="CosmeticItemEntity.NameKey"/> stays and is still served, as the last resort
/// behind this table — but it is not a display name any more, and nothing outside depends on its
/// value.</para>
/// </remarks>
