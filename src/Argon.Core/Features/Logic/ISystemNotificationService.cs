...
{
    Task<SystemNotificationEntity> CreateAsync(Guid userId, string type, Guid? referenceId, string title, string? body = null, DateTimeOffset? expiresAt = null, CancellationToken ct = default);
