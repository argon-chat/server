...
$generalShards = @(
    ...
    @(   # ~272 s serial
        ...
        'BotApiTests'
        'ChannelBadgeTests'
        'ChannelBotInteractionTests'
        'ChannelLinkPreviewTests'
        'ChannelMentionTests'
        ...
        'DirectChatTests'
        'EmailManagerTests'
        'FeatureFlagAdministrationTests'
        'FileStorageRulesTests'
        'FriendGraphRulesTests'
        'InventoryItemTests'
        'MessageTests'
        'MuteTargetTests'
        'OtpTests'
        ...
        'SystemMessageTests'
        'UltimaLifecycleTests'
        'UltimaTests'
        'UserProgressPersistenceTests'
